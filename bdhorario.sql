...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-05-2024 a las 05:36:17
...
(1, 'pbkdf2_sha256$600000$LXvJ74ygdB624YNlbnWGau$P9gSRWlHeiZ9+8hf+5j+jDCdA/kIsP2zw1qxClwIerc=', '2024-05-26 03:34:05.475677', 1, 'admin', '', '', 'admin@gmail.com', 1, 1, '2024-05-25 10:32:14.790398');
...
('eirts6gc8dgb8vrgc5y6ki4we6si298k', '.eJxVjDkOwjAUBe_iGlmJ4wVT0ucM1vdfcAA5UpxUiLtDpBTQvpl5L5VgW0vaGi9pInVRvTr9bhnwwXUHdId6mzXOdV2mrHdFH7TpcSZ-Xg_376BAK98aJAbHrscohryBTCEMQE4G7HokIQe28yRnBCswOIqxs9ZkJvQswur9ARCpOYc:1sB4e5:Ex015JdhqloIJBlxV3huJi4Mz9rCFB_YIMziiEIkunQ', '2024-06-09 03:34:05.480000'),
...
--
-- Estructura de tabla para la tabla `jurado_tesis`
--

CREATE TABLE `jurado_tesis` (
  `id` int(11) NOT NULL,
...
--
-- Indices de la tabla `jurado_tesis`
--
ALTER TABLE `jurado_tesis`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de la tabla `jurado_tesis`
--
ALTER TABLE `jurado_tesis`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `horarios`
  ADD CONSTRAINT `horarios_ibfk_1` FOREIGN KEY (`id_tesis`) REFERENCES `tesis` (`id`);

--
-- Filtros para la tabla `jurado_tesis`
--
ALTER TABLE `jurado_tesis`
  ADD CONSTRAINT `jurado_tesis_ibfk_1` FOREIGN KEY (`id_jurado`) REFERENCES `jurados` (`id`),
  ADD CONSTRAINT `jurado_tesis_ibfk_2` FOREIGN KEY (`id_tesis`) REFERENCES `tesis` (`id`);

--
-- Filtros para la tabla `tesis`
--
ALTER TABLE `tesis`
  ADD CONSTRAINT `tesis_ibfk_1` FOREIGN KEY (`id_estudiante`) REFERENCES `estudiantes` (`id`);
COMMIT;
